...
export default function Dashboard() {
  ...
  const activityFeed = (data?.recentUsers || []).slice(0, 5).map(u => ({
    key: u._id || Math.random().toString(),
    icon: u.name ? u.name.charAt(0).toUpperCase() : "U",
    bg: "#f5f0ec",
    color: "#627B68",
    label: `${u.name || "A user"} joined PropZo`,
...
const statCard = { position: "relative", overflow: "hidden", background: "#fff", padding: "24px", borderRadius: "24px", border: "1px solid #e8d5c8", display: "flex", alignItems: "center", gap: "20px", boxShadow: "0 4px 6px -1px rgba(76,51,36,0.05)", transition: "all 0.3s cubic-bezier(0.4, 0, 0.2, 1)", cursor: "default" };
...
const spinnerWrap = { display: "flex", flexDirection: "column", alignItems: "center" };
const spinner = { width: "40px", height: "40px", border: "4px solid rgba(98,123,104,0.2)", borderTop: "4px solid #627B68", borderRadius: "50%", animation: "spin 1s linear infinite" };
const errorBox = { textAlign: "center", padding: "40px", background: "#fff", borderRadius: "20px", border: "1px solid #e8d5c8", boxShadow: "0 10px 25px -5px rgba(76,51,36,0.1)" };
const liveIndicator = { display: "flex", alignItems: "center", gap: "8px", padding: "8px 12px", background: "#f8fafc", borderRadius: "20px", border: "1px solid #e8d5c8" };
const liveDot = { width: "8px", height: "8px", borderRadius: "50%", background: "#10b981", animation: "pulse 2s infinite" };
const trendBar = { width: "5px", height: "100%", borderRadius: "20px", position: "absolute", left: 0, top: 0 };
const catBadge = (cat) => ({ padding: "4px 8px", borderRadius: "6px", fontSize: "11px", fontWeight: "700", backgroundColor: "#eef2ef", color: "#627B68" });
const emptyState = { padding: "40px 0", textAlign: "center", border: "1px dashed #e8d5c8", borderRadius: "16px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: "100%" };
const activityRow = { display: "flex", gap: "12px", alignItems: "center", padding: "12px", borderRadius: "12px", transition: "background 0.2s" };
const activityIcon = { width: "40px", height: "40px", borderRadius: "12px", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: "700", fontSize: "15px" };
