...
const styles = {
  container: { padding: "0", background: "transparent", minHeight: "100vh" },
  ...
  refreshBtn: { background: "#fff", border: "1px solid #e2e8f0", padding: "10px 18px", borderRadius: "12px", fontWeight: "600", cursor: "pointer", color: "#475569", boxShadow: "0 1px 2px rgba(0,0,0,0.05)" },
  printBtn: { background: "#0f172a", border: "none", color: "#fff", padding: "10px 20px", borderRadius: "12px", fontWeight: "600", cursor: "pointer", boxShadow: "0 4px 6px -1px rgba(15, 23, 42, 0.4)" },
  downloadBtn: { background: "#f1f5f9", border: "1px solid #e2e8f0", color: "#1e293b", padding: "10px 20px", borderRadius: "12px", fontWeight: "600", cursor: "pointer", marginRight: "8px", transition: "all 0.2s" },

  statsGrid: { display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "24px", marginBottom: "32px" },
  statCard: { background: "#fff", padding: "24px", borderRadius: "24px", border: "1px solid #e2e8f0", display: "flex", alignItems: "center", gap: "20px", boxShadow: "0 4px 6px -1px rgba(0,0,0,0.05)" },
  ...
  statValue: { fontSize: "26px", fontWeight: "900", color: "#0f172a", margin: "4px 0 0" },

  contentGrid: { display: "grid", gridTemplateColumns: "2fr 1fr", gap: "32px", marginBottom: "32px" },
  chartCard: { background: "#fff", padding: "28px", borderRadius: "24px", border: "1px solid #e2e8f0", boxShadow: "0 10px 15px -3px rgba(0,0,0,0.05)" },
  ...
  miniStatCard: { background: "#fff", padding: "16px", borderRadius: "20px", border: "1px solid #e2e8f0", textAlign: "center" },
  ...
  statusBreakdown: { background: "#fff", padding: "20px", borderRadius: "20px", border: "1px solid #e2e8f0" },
  subTitle: { margin: "0 0 16px", fontSize: "14px", fontWeight: "700", color: "#475569" },
  ...
  tableCard: { background: "#fff", borderRadius: "24px", border: "1px solid #e2e8f0", boxShadow: "0 10px 15px -3px rgba(0,0,0,0.05)", overflow: "hidden" },
  table: { width: "100%", borderCollapse: "collapse" },
  th: { textAlign: "left", padding: "20px", backgroundColor: "#f8fafc", borderBottom: "1px solid #e2e8f0", color: "#94a3b8", fontSize: "11px", fontWeight: "800", textTransform: "uppercase", letterSpacing: "1px" },
  ...
  statusBadge: { background: "#f0f9ff", color: "#0369a1", padding: "6px 14px", borderRadius: "10px", fontSize: "12px", fontWeight: "800" },
