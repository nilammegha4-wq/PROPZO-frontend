...
//                 .pagination-btn:hover { border-color: #c5a059 !important; color: #c5a059 !important; transform: scale(1.1); }
//                 .pagination-btn.active { background: #c5a059 !important; color: white !important; border-color: #c5a059 !important; }

//                 .filter-select { appearance: none; -webkit-appearance: none; }
//                 .social-icon-footer { transition: all 0.3s ease; }
//                 .social-icon-footer:hover { color: #c5a059 !important; transform: translateY(-3px); }
...
//                                 <p style={{fontSize: '13px', color: '#777', marginTop: '10px', lineHeight: '1.6'}}>{project.desc}</p>

//                                 {project.flexible && (
//                                     <div style={{display: 'flex', gap: '8px', justifyContent: 'center', marginTop: '15px'}}>
//                                         {["Per Hour", "Per Day", "Per Week"].map(t => (
//                                             <span key={t} style={{fontSize: '9px', padding: '4px 10px', border: '1px solid #eee', borderRadius: '15px', color: '#8a6a28', fontWeight: '600', textTransform: 'uppercase', letterSpacing: '1px'}}>
//                                                 {t}
//                                             </span>
//                                         ))}
//                                     </div>
...
//         position: "relative",
//         background: "linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url('https://images.unsplash.com/photo-1613977257363-707ba9348227?q=80&w=2070&auto=format&fit=crop') center/cover no-repeat",
//         padding: "0 20px",
//         textAlign: "center"
//     },
...
//     },
//     brand: { fontWeight: "700", color: "#fff" },
...
//     highlightVal: { fontSize: "24px", fontWeight: "700", color: "#111", letterSpacing: "-1px" },
//     highlightLab: { fontSize: "10px", fontWeight: "600", color: "#8a6a28", letterSpacing: "1px" },
//     highlightLine: { width: "1px", height: "40px", background: "#f0f0f0" },
